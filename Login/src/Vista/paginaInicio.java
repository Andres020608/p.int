...
public class paginaInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPopupMenu11.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPopupMenu11MouseClicked(evt);
            }
        });

        cerrarSesion.setText("jMenuItem1");
        jPopupMenu11.add(cerrarSesion);
        ...
        header.add(joyaDesplegable, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, -1, 50));
        ...
        irbtnLayout.setVerticalGroup(
            ...
            .addGroup(irbtnLayout.createSequentialGroup()
                .addComponent(irtxt, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jPopupMenu11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPopupMenu11MouseClicked
        jPopupMenu11.show(usuarioIcono, evt.getX(), evt.getY());
    }//GEN-LAST:event_jPopupMenu11MouseClicked
